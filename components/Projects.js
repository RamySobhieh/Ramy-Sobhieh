...
function Projects() {
  ...
  return (
    <div id="projects" className="w-full h-full md:min-h-screen">
      <div className="max-w-[1240px] mx-auto px-6 py-16 pt-24 text-center md:text-start">
        <p
          ref={ref}
          className="text-xl font-bold tracking-widest uppercase text-[#8105D8]"
        >
          Projects
        </p>
        ...
        <div className="grid md:grid-cols-2 xl:grid-cols-3 gap-8 ">
          <div className="flex flex-col space-y-6 justify-center items-center hover:scale-105 duration-300 ease-in group">
            <div className="h-[270px] w-[300px] md:w-[350px] rounded-lg overflow-hidden hover:shadow-l shadow-gray-700 duration:300 ease-in">
            ...
            <p className="text-lg text-white/[0.44] group-hover:text-white/[0.87] font-bold">
              Netflix Clone
            </p>
          </div>
          ...
          <div className="flex flex-col space-y-6 justify-center items-center hover:scale-105 duration-300 ease-in group">
            <div className="h-[270px] w-[300px] md:w-[350px] rounded-lg overflow-hidden hover:shadow-l shadow-gray-700 duration:300 ease-in">
              <div className="flex flex-col">
                ...
                <div className="flex justify-center items-center h-[70px] w-full bg-[#8105D8] space-x-10">
                  <Link href="https://zafshop-website.vercel.app/">
                    <div className="text-white/[0.87] hover:text-[#FE59D7] duration-150 ease-in cursor-pointer">
                      <AiOutlineLink className="w-8 h-8" />
                    </div>
                  </Link>

                  <Link href="https://github.com/RamySobhieh/ZAFSHOP-Website">
                    <div className="text-white/[0.87] hover:text-[#FE59D7] duration-150 ease-in cursor-pointer">
                      <FaGithub className="w-8 h-8" />
                    </div>
                  </Link>
